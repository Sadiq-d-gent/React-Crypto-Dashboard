...
const BitcoinSocial = () => {
    ...
    return (
        <div className='flex-col w-96 border shadow rounded-xl text-[#ffffff] bg-[#1B1F2A] pt-3 pb-3 pl-6 pr-6 transform duration-500 hover:-translate-y-2'>
            <div className="">
                <div className="flex items-start">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="ml-20">
                            <a href="#" className="bg-slate-100 px-2 py-1 rounded text-[#1B1F2A] hover:bg-orange-400 hover:text-white">Follow</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="ml-12 mt-2 mb-5">
                <p className="break-words font-semibold text-sm text-slate-950 text-[#ffffff]">
