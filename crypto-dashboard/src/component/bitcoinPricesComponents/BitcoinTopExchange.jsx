...
const BitcoinTopExchange = () => {
    return (
        <div className='flex-col border shadow rounded-xl text-[#ffffff] bg-[#1B1F2A] pt-3 pb-3 pl-6 pr-6 transform duration-500 hover:-translate-y-2'>
                ...
                {exchanges?.map(exchange => {
                    return (
                        <div className="flex mt-4 mb-4" key={exchange?.market_cap_rank}>
                            ...
                            <div className="ml-5">
                                <button className="px-2 py-1 bg-slate-300 rounded hover:bg-orange-400 hover:text-white text-sm font-semibold text-[#1B1F2A]">follow</button>
                            </div>
                        </div>
                    )
                })}
