...
const BitcoinCard = () => {
    ...
    return (
        <div className='flex-col w-96 border shadow rounded-xl bg-[#1B1F2A] pt-3 pb-3 pl-5 pr-5 transform duration-500 hover:-translate-y-2'>
            <div className='flex justify-between mb-3'>
                <div className="flex items-center gap-2">
                    ...
                    <span className='font-semibold text-2xl hover:cursor-pointer text-[#ffffff]'>Bitcoin</span>
                    <div className="ml-2">
                        <span className="font-semibold text-xs text-slate-950 px-1 bg-slate-100 rounded">BTC</span>
                    </div>
                </div>
                <a className='flex items-center gap-3' href="#">
                    <div className="bg px-2 py-1 rounded hover:bg-orange-400">
                        <CiStar className='text-lg text-[#ffffff] hover:text-slate-100' />
                    </div>
                    <div className="bg px-2 py-1 rounded hover:bg-orange-400">
                        <AiOutlineShareAlt className=' text-[#ffffff] hover:text-slate-100' />
                    </div>
                    ...
                    return (
                        <div className="" key={index}>
                            <div className="flex items-baseline gap-4 mt-4 mb-4">
                                <span className="ml-2 mr-5 font-semibold text-4xl text-[#ffffff]">{USDollar.format(coin?.current_price)}</span>
                                <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-baseline gap-3 ml-3 mb-4 mt-7">
                                <div className="flex items-center gap-2 bg-[#f0f4ff] px-2 py-1 rounded transform duration-500 hover:-translate-y-1">
                                    <BsGlobe />
                                    <a href="https://bitcoin.org/en/" className="font-semibold" target='_blank'>website</a>
                                </div>

                                <div className="flex items-center gap-2 bg-[#f0f4ff] px-2 py-1 rounded transform duration-500 hover:-translate-y-2">
                                    <CgFileDocument />
