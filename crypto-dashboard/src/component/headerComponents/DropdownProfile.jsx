...
const DropdownProfile = ({ align }) => {
  ...
  return (
    <div className='flex items-center justify-center bg-slate-100 hover:bg-slate-200 px-2 py-1 rounded-full'>
      <button
        ref={trigger}
      ...
      >
        ...
        <div className="flex items-center truncate">
          {/* <CgProfile className='w-3 h-3' style={{ color: '#1377eb' }} /> */}
          <img src="joker.jpg" className='w-5 h-5 rounded-full' alt="accountImage" />
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 dark:border-slate-700">
            <Link>
              <div className="font-medium text-slate-800 dark:text-slate-100">Sadiq</div>
            </Link>
