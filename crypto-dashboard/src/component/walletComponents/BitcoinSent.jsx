...
const BitcoinSent = () => {
    ...
    return (
        <div className='flex-col w-96 border shadow rounded-xl text-[#ffffff] bg-[#1B1F2A] pt-3 pb-3 pl-5 pr-5 transform duration-500 hover:-translate-y-2'>
            ...
            <Box maw={300} mx="auto">
                <form onSubmit={form.onSubmit((values) => values.btc = values.usd * values.btc)} className='text-[#ffffff]'>
                    <TextInput
                        withAsterisk
